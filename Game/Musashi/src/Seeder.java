...
class Seeder extends Enemy2
{
    ...
    void attack()
    {
        stat = 11;
        motionCount = 0;
        if(app.getRandom(4) == 1 && app.musashi.seedB > 0)
        {
            app.musashi.seedB--;
            if(app.playSound)
                app.seedUse.play();
            app.addMsg("\u9ED2\uFF89\u7A2E\u3092 \u76D7\u307E\u308C\u305F!");
        } else
        if(app.getRandom(4) == 1 && app.musashi.seedGr > 0)
        {
            app.musashi.seedGr--;
            if(app.playSound)
                app.seedUse.play();
            app.addMsg("\u7070\uFF89\u7A2E\u3092 \u76D7\u307E\u308C\u305F!");
        } else
        if(app.getRandom(4) == 1 && app.musashi.seedW > 0)
        {
            app.musashi.seedW--;
            if(app.playSound)
                app.seedUse.play();
